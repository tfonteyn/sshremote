 ...
 * </pre>
 * <p>
 * Edit "/etc/ssh/sshd_config". The port must match {@link #PORT}.
 * <pre>
 *      Port 2222
 ...
 * </pre>
 * <p>
 * Start for multiple connections in background:
 * <pre>
 *     # enable the auth/syslog first
 ...
 * (Windows:  "%USERPROFILE%\.ssh\*.pub"
 * <p>
 * Update the list at {@link ConnectionTest#withKeys()}
 * <p>
 ...
 * "/etc/ssh/sshd_config.d/"; e.g. "ssh4j.conf"
 *
 *<pre>
 *  Port 2222
 *
